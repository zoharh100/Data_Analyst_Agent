...
# ---------------------------------------------------------------------------
# Tool registry ΓÇö maps tool names to callables
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# LLM adapter ΓÇö Universal LLM support (via LiteLLM) or rule-based fallback
# ---------------------------------------------------------------------------
...
def _call_universal_llm(messages: list[dict], model_name: str, api_key: str) -> dict:
    ...
    try:
        ...
        # ╫º╫¿╫Ö╫É╫ö ╫É╫ò╫á╫Ö╫æ╫¿╫í╫£╫Ö╫¬ ╫æ╫É╫₧╫ª╫ó╫ò╫¬ ╫ö╫₧╫ñ╫¬╫ù ╫⌐╫ö╫Æ╫Ö╫ó ╫₧╫ö╫í╫ÿ╫¿╫Ö╫₧╫£╫Ö╫ÿ
...
def _parse_react_response(text: str) -> dict:
    ...
    # No action found ΓÇö treat as final answer
    return {
        "wants_tool": False,
        "tool_name": None,
        "tool_args": None,
